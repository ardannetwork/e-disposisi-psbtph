...
export const Navbar: React.FC<NavbarProps> = ({ onOpenFirebaseModal, onToggleSidebar }) => {
  ...
  return (
    <>
      <header className="sticky top-0 z-[60] bg-slate-900/80 backdrop-blur-md border-b border-slate-800 text-slate-100 px-3 sm:px-4 lg:px-8 py-2 sm:py-3 transition-all overflow-x-hidden">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-3 sm:gap-4 flex-nowrap">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 flex-shrink-0">
          ...
          >
            ...
            {/* ROLE BADGE */}
            <div className="flex items-center gap-1 sm:gap-1.5 px-1.5 sm:px-2 md:px-3 py-1.5 rounded-xl bg-slate-800/90 border border-slate-700 text-xs shadow-md flex-shrink-0">
